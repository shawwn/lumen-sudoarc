...
return({exit = exit, argv = argv, ["path-join"] = path_join, ["get-environment-variable"] = get_environment_variable, ["file-exists?"] = file_exists63, ["path-separator"] = path_separator, ["read-file"] = read_file, write = write, ["write-file"] = write_file})
