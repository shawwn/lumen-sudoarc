...
setenv("yesno", {_stash: true, macro: function (name, body) {
  var _x248 = ["x", "yes"];
  _x248.rest = "l";
  return(["mac", name, _x248, ["o", "yes", "t"], ["quasiquote", ["ado", ["unquote", "x"], ["if", ["unquote", ["quote", body]], ["do", ["unquote", "yes"]], ["do", ["unquote-splicing", "l"]]]]]]);
}});
